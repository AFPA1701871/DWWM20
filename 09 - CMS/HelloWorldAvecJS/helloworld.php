...
class HelloWorld_Plugin{
	...
	{// formulaire de gestion des paramètres pour le module d'administration
		...
		echo '<input type="text" name="helloworld_couleur" value="'.get_option("helloworld_couleur").'"/><br><br>';
		echo '<label>Size</label>';
		echo '<input type="text" name="helloworld_size" value="'.get_option("helloworld_size").'"/>';
		submit_button();
		echo '</form>';
	}
}
